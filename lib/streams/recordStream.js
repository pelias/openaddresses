 ...
 */
function createRecordStream( filePath, dirPath, useOaAdminFields ){
  /**
  ...
  var documentStream = DocumentStream.create(idPrefix, stats, useOaAdminFields);
 ...
 */
function createFullRecordStream(files, dirPath, useOaAdminFields) {
  ...
  files.forEach( function forEach( filePath ){
    recordStream.append( function ( next ){
      ...
      next(createRecordStream( filePath, dirPath, useOaAdminFields ) );
    });
  });
